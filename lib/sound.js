...
var Sound = module.exports = function(app) {
	...
	self.sources = {
		...
		connecting: 'voice-connecting.wav',
		disconnect: 'voice-disconnect.wav',
		accessDenied: 'voice-access-denied.wav',
		accepted: 'voice-accepted.wav'
	};
...
Sound.prototype.trigger = function(ev) {
	...
	if (!self.triggers.hasOwnProperty(ev))
		return;
